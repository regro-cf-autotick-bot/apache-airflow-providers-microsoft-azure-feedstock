...
pixi add apache-airflow-providers-microsoft-azure
# for installing globally
pixi global install apache-airflow-providers-microsoft-azure
```
...
It is possible to list all of the versions of `apache-airflow-providers-microsoft-azure` available on your platform:
...
```
pixi search apache-airflow-providers-microsoft-azure --channel conda-forge
```
